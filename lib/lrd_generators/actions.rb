require 'open-uri'
require 'active_support/deprecation' #Might yank this

#I am copping to it: this is a direct copy of Rails::Generators::Actions from 
#Rails3 - the idea was to be backporting their generators, so there you go
